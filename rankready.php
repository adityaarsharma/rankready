...
if ( ! defined( 'RR_VERSION' ) ) {
	...
	// rc.11 — Hide "Generated from RankReady" credit line (Pro feature stub).
	// Free tier: option ignored, credit always shows.
	// Pro tier (future): toggle effective.
	define( 'RR_OPT_HIDE_BRANDING', 'rr_hide_branding' );
